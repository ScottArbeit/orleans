...
/// <summary>
/// Extension methods for configuring Azure Service Bus streaming on Orleans silos.
/// </summary>
public static class SiloBuilderAzureServiceBusExtensions
{
    /// <summary>
    /// Adds Azure Service Bus streaming to the silo with action-based configuration.
    /// </summary>
    ...
    /// <summary>
    /// Adds Azure Service Bus streaming to the silo with IConfiguration-based configuration.
    /// </summary>
    /// <param name="builder">The silo builder.</param>
    /// <param name="name">The name of the stream provider.</param>
    ...
    /// <summary>
    /// Adds Azure Service Bus queue streaming to the silo.
    /// </summary>
    /// <param name="builder">The silo builder.</param>
    /// <param name="name">The name of the stream provider.</param>
    ...
    /// <returns>The silo builder.</returns>
    public static ISiloBuilder AddAzureServiceBusQueueStreaming(
        this ISiloBuilder builder,
        string name,
    ...
    /// <summary>
    /// Adds Azure Service Bus topic streaming to the silo.
    /// </summary>
    /// <param name="builder">The silo builder.</param>
    /// <param name="name">The name of the stream provider.</param>
    /// <param name="connectionString">The Azure Service Bus connection string.</param>
    ...
    /// <returns>The silo builder.</returns>
    public static ISiloBuilder AddAzureServiceBusTopicStreaming(
        this ISiloBuilder builder,
        string name,
        string connectionString,
        string topicName,
